							...
							<div id="tab1" class="tab-pane fade in active">
								<h4>General</h4>
						          ...
						          <div class="row form-group">
						            ...
						            <div class="col-md-4">
						              	<?php echo $form->textField($model,'name', array('class'=>'form-control', 'placeholder'=>'Name of Restaurant'));
					            ...
					            <div class="row form-group">
						            ...
						            <div class="col-md-4">
						               	<?php echo $form->textField($model,'booking_price', array('class'=>'form-control', 'placeholder'=>'Booking Price')); ?>
								...
								<div class="row form-group">
					         	...
					         	<div class="row form-group">
						            ...
						            <div class="col-md-10">
						              <?php 
						              	 echo $form->textArea($model,'description',array("class"=>"form-control","placeholder"=>"Resturant Description","rows"=>5,"cols"=>60));
							  ...
							  <div class="row form-group">
					           ...
					           <div class="row form-group">
					            ...
					            <div class="col-md-4">
					                <?php echo $form->textField($model,'city_village', array('class'=>'form-control', 'placeholder'=>'Location')); ?>
							  ...
							  <div class="row form-group">
					            ...
					            <div class="col-md-10">
					                <?php 
						              	 echo $form->textArea($model, 'things_todo',array("class"=>"form-control","placeholder"=>"Things to do","rows"=>5,"cols"=>60));
							        ...
							        <div style="margin-bottom: 0px;" class="well well-sm">
								        ...
								        <table class="table">
									        <tbody>
										        ...
										        <td>
										       		<?php 
										       			  echo $form->textField($model,'addressonmap', array('class'=>'form-control', 'placeholder'=>'Address on map'));
									        ...
									        <tr>
										        ...
										        <td>
										        	<?php 
										       			  echo $form->textField($model,'latitude', array('class'=>'form-control', 'placeholder'=>'Latitude'));
									        ...
									        <tr>
										        ...
										        <td>
										        	<?php 
										       			  echo $form->textField($model,'longitude', array('class'=>'form-control', 'placeholder'=>'Latitude'));
			 ...
			 <div class="col-md-12">
			 	...
			 	<h3>Dining Style</h3>
					...
					<div class="row form-group">
  					...
  					<div class="row form-group">
			            ...
			            <div class="col-md-4">
			            	<div class="form-group">
				                <?php 
					              	 //echo $form->textField($model, 'closing_hour',array("class"=>"form-control","placeholder"=>"Closing Hour"));
				                		$this->widget("ext.maskedInput.MaskedInput", array(
							                "model" => $model,
							                "attribute" => "closing_hour",
							                "clientOptions" => array("autoUnmask"=> false, "alias" =>  "hh:mm"), 
	                                    	"defaults"=>array("removeMaskOnSubmit"=>false),
            							));
					...
					<div class="row form-group">
			            ...
			            <div class="col-md-10">
			                <?php 
				              	 echo $form->textArea($model, 'terms_condition',array("class"=>"form-control","placeholder"=>"Terms and conditions","rows"=>5,"cols"=>60));
					...
					<div class="row form-group">
    					...
    					<div class="col-md-4">
   						   <?php 
				              	 //echo $form->textField($model, 'mobile_number',array("class"=>"form-control","placeholder"=>"Contact Person mobile number"));
   						   			$this->widget("ext.maskedInput.MaskedInput", array(
	                                    "model" => $model,
