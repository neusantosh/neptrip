							...
							<div id="tab1" class="tab-pane fade in active">
								<h4>General</h4>
						          ...
						          <div class="row form-group">
						            ...
						            <div class="col-md-4">
						              	<?php echo $form->textField($model,'name', array('class'=>'form-control', 'placeholder'=>'Name of Venue'));
								...
								<div class="row form-group">
					         	...
					         	<div class="row form-group">
						            ...
						            <div class="col-md-10">
						              <?php 
						              	 echo $form->textArea($model,'description',array("class"=>"form-control","placeholder"=>"Venue Description","rows"=>5,"cols"=>60));
							        ...
							        <div style="margin-bottom: 0px;" class="well well-sm">
								        ...
								        <table class="table">
									        ...
									        <tr>
										        ...
										        <td>
										        	<?php 
										       			  echo $form->textField($model,'longitude', array('class'=>'form-control', 'placeholder'=>'Longitude'));
			 	...
			 	<h3> Special For</h3>
					...
					<div class="row form-group">
  					...
  					<div class="row form-group">
    					...
    					<div class="col-md-4">
   						   <?php 
				              	 //echo $form->textField($model, 'phone1',array("class"=>"form-control","placeholder"=>"Phone 1","rows"=>5,"cols"=>60));
					...
					<div class="row form-group">
    					...
    					<div class="col-md-4">
   						   <?php 
				              	 //echo $form->textField($model, 'fb_link',array("class"=>"form-control","placeholder"=>"Facebook Url"));
   						   		$this->widget("ext.maskedInput.MaskedInput", array(
				                          "model" => $model,
				                          "attribute" => "fb_link",
					...
					<div class="row form-group">
    					...
    					<div class="col-md-4">
   						   <?php 
				              	 //echo $form->textField($model, 'weblink',array("class"=>"form-control","placeholder"=>"Website Url"));
   						   		$this->widget("ext.maskedInput.MaskedInput", array(
				                          "model" => $model,
				                          "attribute" => "weblink",
				                          "clientOptions" => array("autoUnmask"=> false,"alias" =>  "url"), 
