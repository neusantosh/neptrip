...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<h3>Add Your Tour</h3>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
               <?php 
                  echo $form->textField($model,'business_name', array('class'=>'form-control','placeholder'=>'Business Name'));
           ...
           <div class="row form-group">
            ...
            <div class="col-md-4">
               <?php 
                  echo $form->textField($model,'tour_name', array('class'=>'form-control','placeholder'=>'Tour Name'));
    	...
    	<div class="row form-group">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-10">
               <?php 
                  echo $form->textArea($model,'tour_description', array('class'=>'form-control','placeholder'=>'Tour Name',"rows"=>5,"cols"=>60));
		 ...
		 <div class="row form-group">
           ...
           <div class="row form-group">
                  ...
                  <div class="row form-group">
                      ...
                      <div class="col-md-4">
                        <?php echo $form->textField($model,'package_price', array('class'=>'form-control', 'placeholder'=>'Pacakage Price')); ?>
                ...
                <div class="row form-group">
                      ...
                      <div class="col-md-10">
                          <?php 
                            echo $form->textArea($model, 'terms_and_policy',array("class"=>"form-control","placeholder"=>"Terms and condition","rows"=>5,"cols"=>60));
                     ...
                     <?php echo $form->labelEx($model,'facebook', array('class'=>'col-md-2 control-label text-left')); ?>
                      <div class="col-md-4">
                          <?php 
                              ...
                              "model" => $model,
                              "attribute" => "facebook",
                              "clientOptions" => array("alias" =>  "url","autoUnmask"=> false),
                              "defaults"=>array("removeMaskOnSubmit"=>false),
                            ));
                      ...
                      <div class="col-md-4">
                        ...
                        ?>
        					...
        					<div class="row form-group">
            					...
            					<div class="col-md-4">
           						   <?php 
                              echo $form->textField($model, 'contact_person_role',array("class"=>"form-control","placeholder"=>"Contact Person Role"));
                ...
                <div class="col-md-6 form-horizontal">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                           <?php 
                              echo $form->textField($model, 'address_on_map',array("class"=>"form-control","placeholder"=>"Address on Map"));
