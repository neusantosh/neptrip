...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
          ...
          <div class="row form-group">
            ...
            <div class="col-md-4">
             <?php 
                  echo $form->textField($model,'car_name', array(
                    'class'=>'form-control',
          ...
          <div class="row form-group">
            ...
            <div class="col-md-10">
              <?php 
                  echo $form->textArea($model, 'car_description',array(
                    "class"       => "form-control",
                    "placeholder" => "Car Description",
                    "rows"        => 5,
                    "cols"        => 60,
                    "value"       => $record['car_description']
                    ));
          ...
          <div class="row form-group">
            ...
            <div class="col-md-10">
              <div class="col-md-6">
                  <?php
                    if($record['image']!='' && file_exists('images/vehicles/'.$record['image'])){
                      $image_url = Yii::app()->baseUrl.'/images/vehicles/'.$record['image'];
                  ?>
                       <div class="vehicle_image">
                          <img src="<?php echo $image_url;?>" width="150px">
                          <br/>
                            <a href="javascript:void(0);" class="btn btn-danger remove_vehicleimage" data-id="<?php echo $record['id'];?>" data-image="<?php echo $record['image'];?>" data-url="<?php echo Yii::app()->createUrl('vehicles/deleteimage');?>">
                              Remove
                            </a>
                        </div>
                  <?php                       
             ...
             <?php echo $form->labelEx($model,'passenger', array('class'=>'col-md-2 control-label text-left')); ?>
              ...
              <?php 
                  echo $form->dropDownList($model,'passenger', array(
                    ...
                    'options'     => array($record['passenger'] => array('selected'=>true)),
                    'class'       =>'form-control'
                    ));
          ...
          <div class="row form-group">
                 ...
                 <?php 
                  echo $form->dropDownList($model,'transmission', array(
                    ...
                    'Other'  => 'Other'
                      ...
                      'options'     => array($record['transmission'] => array('selected'=>true)),
                      'class'       =>'form-control'
                      ));
                    ...
                    <?php 
                      echo $form->dropDownList($model,'baggage', array(
                        ...
                        'x6'=> 'x6'
                          ...
                          'options'     => array($record['baggage'] => array('selected'=>true)),
                          'class'=>'form-control'
                        ));
              ...
              <?php 
                      echo $form->dropDownList($model,'airport_pickup', array(
                        ...
                        0 => 'No'
                          ...
                          'options'     => array($record['airport_pickup'] => array('selected'=>true)),
                          'class'=>'form-control'
                        ));
                  ...
                  <?php 
                          echo $form->dropDownList($model,'car_type', array(
                            ...
                            'Mini' => 'Mini'
                              ...
                              'options'     => array($record['car_type'] => array('selected'=>true)),
                              'class'=>'form-control'
                            ));
            ...
            <div class="row form-group">
                ...
                <div class="col-md-4">
                  <?php 
                    echo $form->textField($model,'pick_up_location', array(
                      'class'       => 'form-control',
                      'placeholder' => 'Pickup Location',
                      'value'       => $record['pick_up_location']
                      ));
                ...
                <div class="col-md-4">
                  <?php 
                      echo $form->textField($model,'drop_off_location', array(
                          'class'       =>'form-control',
                          'placeholder' =>'Dropoff Location',
                          'value'       => $record['drop_off_location']
                        ));
            ...
            <div class="row form-group">
              ...
              <?php echo $form->labelEx($model,'price', array('class'=>'col-md-2 control-label text-left')); ?>
               ...
               <?php echo $form->labelEx($model,'terms_and_condition  ', array('class'=>'col-md-2 control-label text-left')); ?>
                <div class="col-md-10">
                  <?php 
                  echo $form->textArea($model, 'terms_and_condition',array(
                    "class"         => "form-control",
                    "placeholder"   => "Terms and condition",
                    "rows"          => 5,
                    "cols"          => 60,
                    'value'       => $record['terms_and_condition']
                    ));
