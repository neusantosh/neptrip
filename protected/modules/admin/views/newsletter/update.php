<fieldset style="margin-top:40px">
	...
	<?php echo $form->textFieldRow($model, 'newsletter_title', array('class'=>'span3','value'=>$record['newsletter_title'],'readonly'=>'readonly'));?>
	...
	<div class="tinymce">
		...
		<?php 
			$this->widget('application.extensions.tinymce.ETinyMce',array(
				...
				'editorTemplate' => 'full',
				'htmlOptions' => array('rows'=>5, 'cols'=>60, 'class'=>'tinymce span10','value'=>$record['newsletter_content'])
			));
